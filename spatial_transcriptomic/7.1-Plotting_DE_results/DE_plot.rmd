...
```{r}
colData <- read_excel("../Data_Thomas/Q3 - publication - V2.xlsx", sheet = "SegmentProperties")
...
```{r}
Q3_publication <- read_excel("../Data_Thomas/Q3 - publication - V2.xlsx", sheet = "TargetCountMatrix")
...
# DE perilesional vs intralesional
...
# DE extralesional vs intralesionnal
...
# DE extralesional vs perilesional
```{r fig.width=8, fig.height=8}
...
# DE unaffected vs Healthy Control
...
# DE Perilesional vs Healthy Control
```{r fig.width=8, fig.height=8}
