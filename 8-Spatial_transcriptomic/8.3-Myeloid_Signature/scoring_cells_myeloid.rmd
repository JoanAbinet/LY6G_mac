...
```{r}
Norm_exprMat <- read_excel("../Data_DSPDA/Q3 - publication - V2.xlsx", sheet = "TargetCountMatrix")
...
annotation_sample <- read_excel("../Data_DSPDA/Q3 - publication - V2.xlsx", sheet = "SegmentProperties")
