---
title: "Differentiation Primed AT2 => DATPs"
author: "Abinet Joan"
date: "2/2/2023"
...
length(expressed_genes_receiver) # 7170 gènes sélectionner
...
```{r}
DE_PrimedvDATP = FindMarkers(object = epithelial_cells, ident.1 = 2, ident.2 = 4, min.pct = 0.10) %>% rownames_to_column("gene")
...
ggsave("Dotplot_ligand_Motro=>DATPs.png", height = 7, width = 12)
```
